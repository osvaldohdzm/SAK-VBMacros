...
Attribute CYB041_IrACatalogoVulnerabilidad.VB_ProcData.VB_Invoke_Func = "G\n14"
   ...
   Dim wsOrigen As Worksheet, wsCatalogo As Worksheet
    ...
    If tipoOrigen = "" Or IsEmpty(idVulnerabilidad) Then
        MsgBox "No se encontr� un Tipo de Origen o Identificador v�lido en la fila actual.", vbExclamation, "Error"
        Exit Sub
    End If
    ...
    ' Obtener el nombre de la columna de búsqueda en el cat�logo
    ...
    ' Si se encontr�, seleccionar la fila correspondiente en el cat�logo
    If Not celdaEncontrada Is Nothing Then
        wsCatalogo.Activate
        celdaEncontrada.EntireRow.Select
        MsgBox "Registro encontrado. Se ha seleccionado la fila correspondiente en el cat�logo.", vbInformation, "Éxito"
    Else
        MsgBox "No se encontr� el identificador en la tabla de cat�logo.", vbExclamation, "Registro no encontrado"
    End If
End Sub
